...
class Month
{
	public static void main(String args[])//main program to show the name of the month as per the user's choice
	{
         ...
         switch(number) {
         	...
         	break;
         	case(2):
         	System.out.println("Name of the month is Februry");
         	break;
         	case(3):
